...
public class SkorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cursor = db.rawQuery("SELECT * FROM skor WHERE id = '" +
        ...
        skors = Integer.parseInt(String.valueOf(cursor.getString(3).toString()))/5;

        tBenar.setText(String.valueOf(skors));

        Toast.makeText(this, "Kamu benar: "+skors, Toast.LENGTH_SHORT).show();
        nilai = Integer.parseInt(String.valueOf(skors))*10/2;
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent main = new Intent(SkorActivity.this, MainActivity.class);
        ...
        cobalagi.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent main = new Intent(SkorActivity.this, LoginActivity.class);
                main.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                startActivity(main);
            }
        });
    ...
    private void submit_skor (String nim, String nama, String nilai, String id_quiz) {
        class RegisterUser extends AsyncTask<String, Void, String> {
            ...
            protected void onPostExecute(String s) {
                ...
                if(s.equals("1")) {
                    Toast.makeText(SkorActivity.this, "Terima Kasih, Skor Anda Sudah Tersimpan", Toast.LENGTH_SHORT).show();
                }
                else{
                    Toast.makeText(SkorActivity.this, "Gagal menyimpan Skor", Toast.LENGTH_SHORT).show();
                }
            }
